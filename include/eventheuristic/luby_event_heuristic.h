...
#ifndef _LUY_EVENT_HEURISTIC
#define _LUY_EVENT_HEURISTIC
...
class LubyEventHeuristic{
private:

	CONST_PARAM uint32_t base;	
...
public:
	...
	LubyEventHeuristic(char* event_name, const VEC_TYPE( CL_REF )* clause_set, const StringMap& commandline);
