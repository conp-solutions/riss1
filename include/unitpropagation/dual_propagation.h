...
#ifndef _DUAL_PROPAGATION_H
#define _DUAL_PROPAGATION_H
...
public:
	...
	CONST_PARAM bool useLastBinCon;	
...
public:		
	...
	DualUnitPropagation(searchData& search, VEC_TYPE( CL_REF )* clause_set, const uint32_t max_size, const StringMap& commandline);
